...
(
    ...
    rule_group_code INT UNSIGNED                  NOT NULL COMMENT '规则编号（如 1）',
    ...
    INDEX idx_rule_full (rule_group_code, battery_type, signal_type, range_min, range_max)
...
(rule_group_code, warn_name, battery_type, signal_type, range_min, range_max, warn_level, rule_order)
...
INSERT INTO alarm_rule_segment
(rule_group_code, warn_name, battery_type, signal_type, range_min, range_max, warn_level, rule_order)
VALUES ('1', '电压差报警', '三元电池', 'Mx-Mi', 0.000, 0.200, -1, 6);

-- 电压差报警 - 铁锂电池：Mx - Mi < 0.2
INSERT INTO alarm_rule_segment
(rule_group_code, warn_name, battery_type, signal_type, range_min, range_max, warn_level, rule_order)
VALUES ('1', '电压差报警', '铁锂电池', 'Mx-Mi', 0.000, 0.200, -1, 6);

-- 电流差报警 - 三元电池：Ix - Ii < 0.2
INSERT INTO alarm_rule_segment
(rule_group_code, warn_name, battery_type, signal_type, range_min, range_max, warn_level, rule_order)
VALUES ('2', '电流差报警', '三元电池', 'Ix-Ii', 0.000, 0.200, null, 4);

-- 电流差报警 - 铁锂电池：Ix - Ii < 0.2
INSERT INTO alarm_rule_segment
(rule_group_code, warn_name, battery_type, signal_type, range_min, range_max, warn_level, rule_order)
VALUES ('2', '电流差报警', '铁锂电池', 'Ix-Ii', 0.000, 0.200, -1, 4);
